...
knitr::kable(results, 
             format = "simple", 
             caption = "Wilcoxon Test Results for Pesticide Concentration Variations by Type")
...
knitr::kable(results_kruskal, 
             format = "simple", 
             caption = "Kruskal-Wallis Test Results for Pesticide Concentration Variations by Type and Flow Type")
...
knitr::kable(results_table, 
             format = "simple", 
             caption = "Dunn Test Results for Pesticide Concentration Variations by Type and Flow Type")
...
pd_data %>%
  ...
  labs(x = "Predictor Values",
       ...
       title = "Effect of Predictor Variables on Pesticide Concentrations",
       subtitle = "Pesticide Degradates Only")
...
pca_result %>%
  ...
  labs(title = "Scree Plot of PCA",
       subtitle = "Eigenvalues and Cumulative Percentages (Degradates Only)",
...
knitr::kable(loadings_tp, format = "simple", 
             caption = "Coefficients of Loading Plot for Pesticide Degradates")
...
ggbiplot(pca_result, choices = c(1, 2), var.axes = FALSE,
  ...
  xlab("PC1") +
  ylab("PC2") +
  ggtitle("Biplot of PCA", subtitle = "Pesticide Degradates Only") +
...
knitr::kable(summary_table, format = "simple", 
             caption = "Metrics for Predictive Models (Pesticide Degradates)")
...
knitr::kable(min_pest, format = "simple", 
             caption = "Top 20 Performing Pesticide Degradates")
...
knitr::kable(max_pest, format = "simple", 
             caption = "Top 20 Largest Residual Differences for Pesticide Degradates")
